namespace TrafficManager.API.Traffic.Data {
    ...
    public readonly struct SpeedValue {
        ...
        /// </summary>
        [UsedImplicitly]
        public float ToVelocity() => this.GameUnits * ApiConstants.SPEED_TO_VELOCITY;
        ...
        /// <summary>Constructs a SpeedValue from km/hour given as an integer.</summary>
        ...
        /// <summary>Constructs a speed value from km/hour given as a KmphValue.</summary>
        ...
        /// <summary>Constructs a SpeedValue from miles/hour given as an integer.</summary>
        ...
        /// <summary>Constructs a speed value from miles/hour given as a MphValue.</summary>
        ...
        /// <summary>Subtracts two speed values.</summary>
        ...
        /// <summary>Convert float game speed to mph and round to nearest STEP.</summary>
        ...
        public MphValue ToMphRounded(float step) {
            float mph = this.GameUnits * ApiConstants.SPEED_TO_MPH;
            return new MphValue((ushort)(Mathf.Round(mph / step) * step));
        }

        /// <summary>Convert float game speed to km/h and round to nearest STEP.</summary>
        ...
        public KmphValue ToKmphRounded(float step) {
            float kmph = this.GameUnits * ApiConstants.SPEED_TO_KMPH;
        ...
        public MphValue ToMphPrecise()
            => new MphValue((ushort)Mathf.Round(this.GameUnits * ApiConstants.SPEED_TO_MPH));
        ...
        public KmphValue ToKmphPrecise()
            => new KmphValue((ushort)Mathf.Round(this.GameUnits * ApiConstants.SPEED_TO_KMPH));
