...
namespace TMUnitTest.Util {
	...
	public class TinyDictionaryUnitTest {
		...
		private TinyDictionary<ISet<string>, bool> dict3;
		...
		private static ISet<string> girls, boys;

		public TinyDictionaryUnitTest() {
		...
		public void InitializeTest() {
			...
			dict3 = new TinyDictionary<ISet<string>, bool>();
		...
		public void TestKeys3() {
			ICollection<ISet<string>> keys = dict3.Keys;
			Assert.IsNotNull(keys);
