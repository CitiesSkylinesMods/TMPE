...
namespace TrafficManager.Patch._VehicleAI._RTramBaseAI {
    ...
    public static class SimulationStepPatch {
        ...
        public static bool ApplyPatch(Harmony harmonyInstance, Type rTramBaseAIType) {
            try {
                var original = TranspilerUtil.DeclaredMethod<TargetDelegate>(rTramBaseAIType, "SimulationStep");
                if (original == null) return false;

                var transpiler = typeof(SimulationStepPatch).GetMethod("TranspileRTramSimulationStep");
        ...
        public static IEnumerable<CodeInstruction> TranspileRTramSimulationStep(ILGenerator il, IEnumerable<CodeInstruction> instructions) {
