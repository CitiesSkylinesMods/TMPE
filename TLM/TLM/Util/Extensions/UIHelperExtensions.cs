namespace TrafficManager.Util.Extensions {
    ...
    internal static class UIHelperExtensions {
        ...
        public static CustomDownDown AddCustomDropDown(this UIHelperBase container, string text, string[] options, int defaultSelection, OnDropdownSelectionChanged eventCallback) {
        if (eventCallback != null && !string.IsNullOrEmpty(text)) {
            ...
            dropdown.listScrollbar = CreateScrollbar();
    ...
    private static UIScrollbar CreateScrollbar() {
        UIScrollbar verticalScrollbar = new GameObject("Scrollbar").AddComponent<UIScrollbar>();
