...
//                ushort segmentId = vState.currentSegmentId;
        ...
        private void _guiCitizens() {
            ...
            for (int i = 1; i < CitizenManager.MAX_INSTANCE_COUNT; ++i) {
                ...
                String labelStr = "Inst. " + i + ", Cit. " + citManager.m_instances.m_buffer[i].m_citizen + ",\nm: " + ExtCitizenInstanceManager.Instance.ExtInstances[i].pathMode.ToString() + ", tm: " +
                                  ExtCitizenManager.Instance.ExtCitizens[citManager.m_instances.m_buffer[i].m_citizen].transportMode + ", ltm: " + ExtCitizenManager.Instance.ExtCitizens[citManager.m_instances.m_buffer[i].m_citizen].lastTransportMode + ", ll: " +
                                  ExtCitizenManager.Instance.ExtCitizens[citManager.m_instances.m_buffer[i].m_citizen].lastLocation;
        ...
        private void _guiBuildings() {
            ...
            for (int i = 1; i < BuildingManager.MAX_BUILDING_COUNT; ++i) {
                ...
                String labelStr = "Building " + i + ", PDemand: " + ExtBuildingManager.Instance.ExtBuildings[i].parkingSpaceDemand + ", IncTDem: " + ExtBuildingManager.Instance.ExtBuildings[i].incomingPublicTransportDemand + ", OutTDem: " +
