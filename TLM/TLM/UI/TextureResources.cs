...
namespace TrafficManager.UI {
    public class TextureResources {
        ...
        /// <summary>
        /// Groups resources for Lane Arrows Tool
        /// </summary>
        public struct LaneArrows {
            public static readonly Texture2D Atlas;

            public static readonly Texture2D ButtonLeft; // white
            public static readonly Texture2D ButtonLeftOff; // black
            public static readonly Texture2D ButtonLeftDisabled; // crossed

            public static readonly Texture2D ButtonRight; // white
            public static readonly Texture2D ButtonRightOff; // black
            public static readonly Texture2D ButtonRightDisabled; // crossed

            public static readonly Texture2D ButtonForward; // white
            public static readonly Texture2D ButtonForwardOff; // black
            public static readonly Texture2D ButtonForwardDisabled; // crossed

            static LaneArrows() {
                LaneArrows.Atlas = LoadDllResource("LaneArrows.Atlas_Lane_Arrows.png", 256, 32);

                LaneArrows.ButtonLeft = LoadDllResource("LaneArrows.ButtonL.png", 80, 127);
                LaneArrows.ButtonLeftOff = LoadDllResource("LaneArrows.ButtonLOff.png", 80, 127);
                LaneArrows.ButtonLeftDisabled = LoadDllResource("LaneArrows.ButtonLDisabled.png", 80, 127);

                LaneArrows.ButtonRight = LoadDllResource("LaneArrows.ButtonR.png", 80, 127);
                LaneArrows.ButtonRightOff = LoadDllResource("LaneArrows.ButtonROff.png", 80, 127);
                LaneArrows.ButtonRightDisabled = LoadDllResource("LaneArrows.ButtonRDisabled.png", 80, 127);

                LaneArrows.ButtonForward = LoadDllResource("LaneArrows.ButtonF.png", 127, 65);
                LaneArrows.ButtonForwardOff = LoadDllResource("LaneArrows.ButtonFOff.png", 127, 65);
                LaneArrows.ButtonForwardDisabled = LoadDllResource("LaneArrows.ButtonFDisabled.png", 127, 65);
            }
            ...
            public static Sprite GetArrowsSprite(NetLane.Flags flags) {
                ...
                return Sprite.Create(Atlas,
                                     new Rect(spriteIndex * 32f, 0, 32f, 32f),
                                     Vector2.zero);
            }
        }
