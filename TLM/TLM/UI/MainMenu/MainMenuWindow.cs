...
namespace TrafficManager.UI.MainMenu {
    ...
    public class MainMenuWindow
        ...
        public void SetupControls(UBuilder builder) {
            ...
            UPanel innerPanel = builder.Panel<U.UPanel, UIComponent>(
                parent: this,
                setupFn: (UPanel p) => { p.name = "TMPE_MainMenu_InnerPanel"; });
            ...
            AddButtonsResult toolButtonsResult = SetupControls_ToolPanel(innerPanel, builder);
        ...
        private void SetupControls_OnscreenDisplayPanel(UBuilder builder) {
            ...
            osdPanel.SetPadding(UConst.UIPADDING);

            // The keybinds panel belongs to main menu but does not expand it to fit
            osdPanel.ContributeToBoundingBox(false);
            this.OnscreenDisplayPanel = osdPanel;

            osdPanel.ResizeFunction(
                r => {
        ...
        private UILabel SetupControls_TopRow(UBuilder builder) {
            ...
            osdToggle.uCanActivate = c => true;
            osdToggle.uIsActive = c => GlobalConfig.Instance.Main.KeybindsPanelVisible;
            osdToggle.uOnClick += (component, eventParam) => {
        ...
        private AddButtonsResult SetupControls_ToolPanel(UPanel parent, UBuilder builder) {
            // This is tool buttons panel
            var leftPanel = builder.Panel<U.UPanel, UIComponent>(
                parent: this,
                setupFn: panel => { panel.name = "TMPE_MainMenu_ToolPanel"; });
            leftPanel.ResizeFunction(
                (UResizer r) => {
        ...
        private void SetupControls_ExtraPanel(UPanel parent,
            ...
            UPanel rightPanel = builder.Panel<U.UPanel, UIComponent>(
                parent: this,
                setupFn: (UPanel p) => {
        ...
        private AddButtonsResult AddButtonsFromButtonDefinitions(UIComponent parent,
                                                                 UBuilder builder,
            ...
            foreach (MenuButtonDef buttonDef in buttonDefs) {
                ...
                ButtonsDict.Add(buttonDef.Mode, button);
