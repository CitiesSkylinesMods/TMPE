namespace TrafficManager.UI.SubTools {
    ...
    public class VehicleRestrictionsTool : SubTool {
        private static ExtVehicleType[] roadVehicleTypes = {
            ExtVehicleType.PassengerCar, ExtVehicleType.Bus, ExtVehicleType.Taxi,
            ExtVehicleType.CargoTruck, ExtVehicleType.Service, ExtVehicleType.Emergency
        };

        private static ExtVehicleType[] railVehicleTypes = {
