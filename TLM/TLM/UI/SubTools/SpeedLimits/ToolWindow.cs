    ...
    internal partial class ToolWindow : U.Panel.BaseUWindowPanel {
        ...
        public void SetupControls(UBuilder builder, SpeedLimitsTool parentTool) {
            ...
            modeDescriptionWrapPanel_ =
                builder.Panel<ModeDescriptionPanel, UIComponent>(
                    parent: this,
            ...
            palettePanel_ = builder.Panel<PalettePanel, UIComponent>(
                parent: this,
                stack: UStackMode.None);
        ...
        private void SetupControls_ModeButtons(UBuilder builder) {
            modeButtonsPanel_ = builder.Panel<ModeButtonsPanel, UIComponent>(parent: this);
