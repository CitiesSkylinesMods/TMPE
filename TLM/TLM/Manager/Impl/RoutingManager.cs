namespace TrafficManager.Manager.Impl {
          ...
          IRoutingManager
    {
        ...
        protected void RecalculateLaneEndRoutingData(ushort segmentId,
            ...
            ushort prevSegmentId = segmentId; // this variable is duplicate (prevSegmentId == segmentId always)
            int prevLaneIndex = laneIndex; // this variable is duplicate (prevLaneIndex == laneIndex always)
                        ...
                        (prevLaneInfo.m_vehicleType & nextLaneInfo.m_vehicleType) != VehicleInfo.VehicleType.None)
                    {
                        ...
                        if ((nextLaneInfo.m_finalDirection & nextDir2) != NetInfo.Direction.None) {
                            ...
                            if (isNextSegmentValid) {
                                ...
                                bool stayInlanetracks = similarLaneCountMatches & outerSimilarLaneIndexMatches; 
