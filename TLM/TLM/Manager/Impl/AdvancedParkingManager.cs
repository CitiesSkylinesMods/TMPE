namespace TrafficManager.Manager.Impl {
          ...
          IAdvancedParkingManager
    {
                ...
                while (segmentId != 0) {
                        ...
                        out _))
                    {
                                ...
                                laneInfo.m_finalDirection))
                        {
                            ...
                            {
                                if (Constants.ManagerFactory.GameConnectionManager.PassengerCarAIConnection.FindParkingSpaceRoadSide(
                                    ignoreParked,
                                    segmentId,
                                    innerParkPos,
                                    width,
        ...
        public bool FindParkingSpacePropAtBuilding(VehicleInfo vehicleInfo,
                ...
                VehicleInfo.VehicleType.None)
            {
                foreach (BuildingInfo.Prop prop in buildingInfo.m_props) {
                    ...
                    if (Constants.ManagerFactory.GameConnectionManager.PassengerCarAIConnection.FindParkingSpaceProp(
                            isElectric,
                            ignoreParked,
                            propInfo,
                            position,
        ...
        public bool VanillaFindParkingSpaceWithoutRestrictions(bool isElectric,
                                                                ...
                                                                out Quaternion parkRot,
                                                                out float parkOffset) {
            if (!Constants.ManagerFactory.GameConnectionManager.PassengerCarAIConnection.FindParkingSpace(isElectric,
                                                       homeId,
                                                       refPos,
                                                       searchDir,
                                                       segment,
