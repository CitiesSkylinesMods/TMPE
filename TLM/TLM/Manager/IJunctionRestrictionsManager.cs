...
namespace TrafficManager.Manager {
	public interface IJunctionRestrictionsManager {
		...
		bool IsUturnAllowedConfigurable(ushort segmentId, bool startNode);
		...
		bool IsLaneChangingAllowedWhenGoingStraightConfigurable(ushort segmentId, bool startNode);
		...
		bool IsEnteringBlockedJunctionAllowedConfigurable(ushort segmentId, bool startNode);
		...
		bool IsPedestrianCrossingAllowedConfigurable(ushort segmentId, bool startNode);
		...
		bool GetDefaultUturnAllowed(ushort segmentId, bool startNode);
		...
		bool GetDefaultLaneChangingAllowedWhenGoingStraight(ushort segmentId, bool startNode);
		...
		bool GetDefaultEnteringBlockedJunctionAllowed(ushort segmentId, bool startNode);
		...
		bool GetDefaultPedestrianCrossingAllowed(ushort segmentId, bool startNode);
	}
}
